...
public enum VisualItems {
    ...
    RANK_GREEN(Material.LIME_WOOL,1,ChatColor.GREEN + "Rang : Green",ChatColor.GRAY + " Prochain Rang : Blue (" + BankRank.BLUE.getPrice() + ")", 0,21),
    RANK_BLUE(Material.LIGHT_BLUE_WOOL,1,ChatColor.AQUA + "Rang : Blue",ChatColor.GRAY + " Prochain Rang : Purple (" + BankRank.PURPLE.getPrice() + ")", 0,21),
    PURPLE(Material.MAGENTA_WOOL,1,ChatColor.LIGHT_PURPLE + "Rang : Purple",ChatColor.GRAY + " Prochain Rang : Red (" + BankRank.RED.getPrice() + ")", 0,21),
    RANK_RED(Material.RED_WOOL,1,ChatColor.RED + "Rang : Red",ChatColor.GRAY + " Prochain Rang : Orange (" + BankRank.YELLOW.getPrice() + ")", 0,21),
    RANK_YELLOW(Material.YELLOW_WOOL,1,ChatColor.YELLOW + "Rang : Yellow",ChatColor.GRAY + " Prochain Rang : Gold (" + BankRank.GOLD.getPrice() + ")", 0,21),
    RANK_GOLD(Material.GOLD_BLOCK,1,ChatColor.GOLD + "Rang : Gold","", 0,21),
